...
- [JavaScript for React: A Cheat Sheet](https://github.com/Momentum-Team-13/notes/blob/main/js-for-react.md) -> You'll need to understand all of the JS on this page to be able to use React effectively. It would be useful to type out the examples and run them yourself.
